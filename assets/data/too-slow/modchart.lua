...
function update (elapsed)
    ...
    if curStep >= 789 and curStep < 923 then
        for i=0,8 do
            setActorY(_G['defaultStrum'..i..'Y'] + 85 * math.sin((currentBeat + i*1) * math.pi), i)
        end
    end

    if curStep >= 924 and curStep < 1048 then
        for i=0,8 do
            setActorY(_G['defaultStrum'..i..'Y'] + 84 * math.sin((currentBeat + i*1) * math.pi), i)
        end
    end

    if curStep >= 1049 and curStep < 1176 then
        for i=0,8 do
            setActorX(_G['defaultStrum'..i..'X'] + 83 * math.sin((currentBeat + i*1) * math.pi), i)
        end
    end

    if curStep >= 1177 and curStep < 1959 then
        for i=0,8 do
            setActorX(_G['defaultStrum'..i..'X'] + 82 * math.sin((currentBeat + i*1) * math.pi), i)
        end
    end
